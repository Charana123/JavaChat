...
import com.charana.chat_window.ui.conversation.ConversationWindowController;
...
public class ConversationWindow_TEST extends Application{
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        serverAPI.getAccount("albie@gmail.com", (Boolean success, Account account) -> {
            if(success){
                ...
                Scene scene = new Scene(ConversationWindowController.getInstance(account));
